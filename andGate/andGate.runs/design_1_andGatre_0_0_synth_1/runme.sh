...
HD_PWD='/home/subi/codes/vscode/vivado/PL-and-PS/andGate/andGate.runs/design_1_andGatre_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_andGatre_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_andGatre_0_0.tcl
